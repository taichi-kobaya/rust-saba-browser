...
pub struct Node {
    ...
    precious_sibling: Weak<RefCell<Node>>,
...
impl Node {
    ...
    pub fn set_first_child(&mut self, first_child: Option<RefCell<Node>>) {
    ...
    pub fn set_previous_sibling(&mut self, previous_sibling: Weak<RefCell<Node>>) {
        self.precious_sibling = previous_sibling;
    }

    pub fn precious_sibling(&self) -> Weak<RefCell<Node>> {
        self.precious_sibling.clone()
    }
